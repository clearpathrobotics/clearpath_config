...
from clearpath_config.platform.pacs import BracketsConfig, FullRisersConfig, RowRisersConfig
...
class J100DecorationsConfig(BaseDecorationsConfig):
    ...
    def __init__(self) -> None:
        ...
        self.front_bumper = Decorations.Bumper(enable=True, extension=0.0, model=Decorations.Bumper.DEFAULT)
        self.rear_bumper = Decorations.Bumper(enable=True, extension=0.0, model=Decorations.Bumper.DEFAULT)
